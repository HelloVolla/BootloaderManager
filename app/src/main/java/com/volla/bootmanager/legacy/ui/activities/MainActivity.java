...
import com.volla.bootmanager.legacy.devices.DeviceModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_roms, R.id.nav_about, R.id.nav_sd)
    ...
    public boolean mount(DeviceModel d) {
        if (SuFile.open("/data/abm/bootset/db").exists())
            return true;
        Shell.Result result;
        if(!(result = Shell.sh("/data/data/com.volla.bootmanager/assets/Scripts/config/mount/" + d.codename + ".sh").exec()).isSuccess()) {
    ...
    public boolean umount(DeviceModel d) {
        ...
        if(!(result = Shell.sh("/data/data/com.volla.bootmanager/assets/Scripts/config/umount/" + d.codename + ".sh").exec()).isSuccess()) {
            Log.e("ABM_MOUNT",String.join("",result.getOut()));
            Log.e("ABM_MOUNT",String.join("",result.getErr()));
            return false;
        }
