...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean mount(DeviceModel d) {
        if (SuFile.open("/data/abm/bootset/db").exists())
            return true;
        Shell.Result result;
        if(!(result = Shell.sh("/data/data/org.androidbootmanager.app/assets/Scripts/config/mount/yggdrasil.sh").exec()).isSuccess()) {
    ...
    public boolean umount(DeviceModel d) {
        ...
        if(!(result = Shell.sh("/data/data/org.androidbootmanager.app/assets/Scripts/config/umount/yggdrasil.sh").exec()).isSuccess()) {
            Log.e("ABM_MOUNT",String.join("",result.getOut()));
            Log.e("ABM_MOUNT",String.join("",result.getErr()));
            return false;
        }
